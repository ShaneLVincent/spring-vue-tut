package com.sv.springvue.springvuetut;
...
public class JPAUnitTest {
    ...
    public void should_find_tutorials_by_title_containing_string() {
        Tutorial tut1 = new Tutorial("Spring Boot Tut", "Desc 1", true);
        entityManager.persist(tut1);

        Tutorial tut2 = new Tutorial("Java Tut", "Desc 2", false);
        entityManager.persist(tut2);

        Tutorial tut3 = new Tutorial("Spring Data JPA Tut", "Desc 3", true);
        entityManager.persist(tut3);
    ...
    public void should_update_tutorial_by_id() {
        ...
        Tutorial updatedTut = new Tutorial("Updated Tut", "Updated Desc", true);
    ...
    public void should_delete_tutorial_by_id() {
        ...
        assertThat(tutorials).hasSize(2).contains(tut1, tut3).doesNotContain(tut2);
    }
